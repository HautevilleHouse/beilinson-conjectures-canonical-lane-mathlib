# Beilinson Conjectures — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/beilinson-conjectures-canonical-lane-mathlib.git
cd beilinson-conjectures-canonical-lane-mathlib
lake exe
lake build
```
