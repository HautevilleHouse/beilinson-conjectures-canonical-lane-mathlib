/-!
# beilinson-conjectures-canonical-lane Lean migration boundary
...
`BeilinsonConjecturesCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "beilinson-conjectures-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/beilinson-conjectures-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Beilinson conjectures: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["arithmetic-geometry", "l-functions", "mathematical-proof", "motives", "regulators", "reproducibility", "beilinson-conjectures", "canonical-lane", "local-to-global", "manifold-constrained"]
